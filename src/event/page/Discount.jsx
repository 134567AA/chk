...
function List(props){
 ...
 function Discount() {
  ...
  const imgL = [
    ...
    {id: 8, name : "매일 제공! 페이코인 결제 시 영화 50% 할인!", url : "images/할인/img8.jpg",date :"2022.04.10 ~ 2022.04.25" },
    ...
    {id: 11, name : "CHK 우리카드 출시 최대 5천원 할인!", url : "images/할인/img11.jpg",date :"2022.04.30 ~ 2022.06.30" },
